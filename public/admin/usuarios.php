...
<body>
    ...
    //Actualiza el valor del booleano del campo validado (true = not true, false = not false)
    if (isset($id)) {
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 text-center">
                                ...
                                <form action="" method="POST" class="inline">
                                    ...
                                    <!-- Esto solo son botones de tipo submit que envian el id (input -> $fila_id) de la fila del usuario-->
